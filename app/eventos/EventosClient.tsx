...
export default function EventosClient({ events }: { events: Event[] }) {
  ...
  return (
    <>
      <main className="mx-auto max-w-7xl px-6 pb-24 pt-28 text-white md:px-10 md:pt-32">
        <section className="rounded-3xl border border-white/10 bg-white/[0.05] p-4 shadow-[0_0_35px_rgba(168,85,247,0.08)] backdrop-blur-xl md:p-5">
